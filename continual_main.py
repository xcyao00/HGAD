...
def parse_args():
    parser = argparse.ArgumentParser('HGAD-CL: Hierarchical Gaussian Mixture Normalizing Flow Modeling for Continual Anomaly Detection')
    ...
    parser.add_argument('--lr_decay_epochs', nargs='+', default=[48, 57, 88],
    ...
    parser.add_argument('--num_tasks', type=int, default=5,
                        help='number of tasks for continual learning (default: 5)')
    parser.add_argument('--classes_per_task', type=int, default=3,
                        help='number of classes per task (default: 3)')
...
if __name__ == '__main__':
    ...
    exp_name = f"continual_{args.dataset}_seed{args.seed}_gpu{args.gpu}_{timestamp}"
    ...
    continual_train.continual_train(args) 